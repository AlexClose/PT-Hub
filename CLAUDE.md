...
**Last Updated:** HEAD `425a945` — the data-lux dashboard overhaul was REVERTED after the user saw it live and found it worse; index.html restored to pre-change (5384720). See the top session-log entry.
